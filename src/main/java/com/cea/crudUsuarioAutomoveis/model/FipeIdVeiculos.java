...
public class FipeIdVeiculos {
	...
	public FipeIdVeiculos() {

	}

	public FipeIdVeiculos(String fipe_marca, String fipe_codigo, String name, String marca, String key, String veiculo,
			String id) {
