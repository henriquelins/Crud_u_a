...
public class FipeCodVeiculos {
	...
	public FipeCodVeiculos() {

	}

	public FipeCodVeiculos(String fipe_marca, String name, String marca, String key, String id, String fipe_name) {
